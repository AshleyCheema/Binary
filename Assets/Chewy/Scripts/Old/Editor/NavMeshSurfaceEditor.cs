...
namespace UnityEditor.AI
{
    ...
    class NavMeshSurfaceEditor : Editor
    {
        ...
        static NavMeshData GetNavMeshAssetToDelete(NavMeshSurface navSurface)
        {
            ...
            if (prefabType == PrefabAssetType.Regular || prefabType == PrefabAssetType.NotAPrefab)
            {
                // Don't allow deleting the asset belonging to the prefab parent
                var parentSurface = PrefabUtility.GetCorrespondingObjectFromSource<NavMeshSurface>(navSurface);
